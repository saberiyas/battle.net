let apiBattel2 = async () => {
    let req = await fetch("https://saberiyas.github.io/battel-server/trendingnow.json");
    ...
    document.querySelector("#container3").insertAdjacentHTML("afterbegin", cards.join(""));
};
