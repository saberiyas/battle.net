let apiBattel1 = async () => {
    let req = await fetch("https://saberiyas.github.io/battel-server/featured.json");
    ...
    document.querySelector("#container2").insertAdjacentHTML("afterbegin", cards.join(""));
};
